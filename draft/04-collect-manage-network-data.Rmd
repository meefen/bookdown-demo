...
If you've not used R before, please take Module 1 of this [free course on Introduction to R](https://www.datacamp.com/courses/free-introduction-to-r). If you have questions, post them in the `q_and_a` channel or DM Bodong.

Below are R codes to get you started (also downloadable from [the #SNAEd Github repository](https://github.com/meefen/sna-ed/blob/master/assets/lab_1.R)). Please make sure the `igraph` R package is installed in your system as it is beyond `Base R`. Not familiar with installing additional R packages, check out [this video](https://www.youtube.com/watch?v=u1r5XTqrCTQ).
