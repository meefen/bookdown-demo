...
In the previous week, I enjoyed reading your Hypothesis annotations and interactions. I especially appreciate your efforts in connecting concepts across weeks, and connecting concepts with your own work. For example, **Ramya** [asked](https://hyp.is/_HHwJv1nEean4-OGO81R9A/methods.sagepub.com.ezp1.lib.umn.edu/book/social-network-analysis-and-education/n6.xml) about the connection between *cutpoints* and *network cohesion*; **Tina** [recognized](https://hyp.is/_HHwJv1nEean4-OGO81R9A/methods.sagepub.com.ezp1.lib.umn.edu/book/social-network-analysis-and-education/n6.xml) similarities between *cutpoints* and *bridges*; **Derek** [pointed out](https://hyp.is/oyDt5AA_Eee_lBskXThq7Q/methods.sagepub.com.ezp1.lib.umn.edu/book/social-network-analysis-and-education/n6.xml) several important decisions we need to make when applying concepts in a particular context. These are all great and thanks for engaging each other in diving deeper in these areas! Please watch the video below to get started with Week 8:
...
Note: If you haven't done so yet, please the video I made in Week 7. You can add new code dealing with ego-centric networks in to your earlier code. (This is when you're starting to love R if the past few weeks were a bit rough :).)
...
1. **Read** [Carolan (2014), ch. 7](http://methods.sagepub.com.ezp1.lib.umn.edu/book/social-network-analysis-and-education/n7.xml).  **Annotate** as we normally do using proper hashtags (e.g., `question`, `idea`). 
