...
- **Play & Share** (more details on Section \@ref(import-data))
    ...
    - Share the network visualization you make in the `assignment` channel, due by **Monday Feb 6, 11:59PM**
...
Below are R codes to get you started. Please make sure the `igraph` R package is installed in your system. You can go far beyond than the codes, and make sure you please share what you make to our Slack `assignment` channel.
